...
export const UnreadNavigationBar: React.FC<UnreadNavigationBarProps> = ({
  ...
  const showLoading = isLoading && totalUnread === 0
  ...
  return (
    ...
    >
      <div className="unread-nav-left">
        {showLoading ? (
          <div className="unread-nav-badge unread-nav-badge--loading">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="unread-nav-spinner">
