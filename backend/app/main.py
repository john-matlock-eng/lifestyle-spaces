...
# Import API routes
from app.api.routes import auth, users, spaces, invitations, user_profile, journals, templates, llm, highlights, websocket_highlights, activities, framework_templates
...
app.include_router(framework_templates.router)
