...
from app.api.routes.user_profile import get_user_profile, update_user_profile, complete_onboarding
from app.api.routes.users import register_user, get_user_spaces
from app.core.config import Settings, parse_cors
from app.models.common import PaginationParams
from app.models.user import UserCreate
from app.models.user_profile import UserProfileUpdate, OnboardingCompleteRequest, UserProfileBase
...
class TestUsersRouteCoverage:
    ...
    async def test_get_user_spaces_throughput_exceeded(self):
        ...
        with patch("app.api.routes.users.SpaceService") as mock_service_class:
            ...
            mock_service.list_user_spaces.side_effect = ClientError(error_response, "Query")
...
class TestEdgeCases:
    ...
    def test_user_profile_bio_with_script_tags(self):
        ...
        profile = UserProfileBase(bio="<script>alert('xss')</script>Normal text<b>bold</b>")
