...
from app.services.exceptions import SpaceNotFoundError, InvalidInviteCodeError, AlreadyMemberError
...
class TestSpaceServiceInvitations:
    ...
    def test_regenerate_invite_code_success(self, mock_secrets, mock_datetime):
        ...
        self.mock_table.get_item.return_value = {
            "Item": {"PK": "SPACE#space123", "SK": "METADATA", "invite_code": "OLDCODE"}
        }
    ...
    def test_join_space_with_invite_code_already_exists(self):
        ...
        self.mock_table.query.return_value = {"Items": [{"space_id": "space123"}]}

        with pytest.raises(AlreadyMemberError) as exc_info:
            self.service.join_space_with_invite_code(invite_code="VALIDCODE", user_id="user456")
    ...
    def test_join_space_with_invite_code_invalid_code(self):
        ...
        with pytest.raises(InvalidInviteCodeError) as exc_info:
            self.service.join_space_with_invite_code(invite_code="BADCODE", user_id="user456")
