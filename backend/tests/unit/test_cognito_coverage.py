        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.list_user_pools.return_value = {
                    "UserPools": [{"Name": "other-pool", "Id": "other-id"}]
                }
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.list_user_pool_clients.return_value = {
                    "UserPoolClients": [{"ClientName": "other-client", "ClientId": "other-id"}]
                }
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.list_users.return_value = {
                    "Users": [{"Username": "test-username", "Attributes": []}]
                }
                ...
                mock_client.list_users.assert_called_once_with(
                    UserPoolId="test-pool-id", Filter='email = "test@example.com"', Limit=1
                )
