...
class TestSpaceServiceCoverage:
    ...
    def test_create_table_already_exists(self):
        ...
        with patch.object(service.dynamodb, "create_table") as mock_create, patch.object(
    ...
    def test_update_space_with_description_only(self):
        ...
        # Add membership
        self.table.put_item(Item={"PK": "SPACE#space123", "SK": "MEMBER#user123", "role": "owner"})
        ...
        response = self.table.get_item(Key={"PK": "SPACE#space123", "SK": "METADATA"})
    ...
    def test_remove_member_owner_check(self):
        ...
        self.table.put_item(Item={"PK": "SPACE#space123", "SK": "MEMBER#admin123", "role": "admin"})
    ...
    def test_can_edit_space_client_error(self):
        ...
        with patch.object(service.table, "get_item") as mock_get:
            mock_get.side_effect = ClientError(
                error_response={"Error": {"Code": "InternalError"}}, operation_name="GetItem"
            )
...
class TestInvitationServiceCoverage:
    ...
    def test_get_or_create_table_exception(self):
        ...
        with patch("app.services.invitation.boto3.resource") as mock_boto, patch(
            "app.services.invitation.DynamoDBClient"
        ) as mock_db_client:
            mock_dynamodb = Mock()
            mock_boto.return_value = mock_dynamodb
