...
class TestUserModels:
    ...
    def test_user_base_model_valid(self):
        ...
        user_data = {"email": "test@example.com", "username": "testuser", "full_name": "Test User"}
    ...
    def test_user_base_model_email_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UserBase(email="invalid-email", username="testuser", full_name="Test User")
    ...
    def test_user_create_password_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UserCreate(email="test@example.com", username="testuser", password="short")
    ...
    def test_token_response_model(self):
        ...
        token_data = {"access_token": "jwt-token-here", "token_type": "bearer", "expires_in": 3600}
...
class TestSpaceModels:
    ...
    def test_space_base_defaults(self):
        ...
        space = SpaceBase(name="My Workspace")
    ...
    def test_space_list_response_model(self):
        ...
        list_response = SpaceListResponse(spaces=spaces, total=3, page=1, page_size=10)
    ...
    def test_calendar_url_validation_https_required(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            SpaceCreate(
                name="Test Space", calendar_url="http://calendar.google.com/calendar/embed?src=test"
            )
    ...
    def test_calendar_url_validation_allowed_domains(self):
        ...
        space = SpaceCreate(
            name="Test Space", calendar_url="https://calendar.google.com/calendar/embed?src=test"
        )
        assert space.calendar_url == "https://calendar.google.com/calendar/embed?src=test"

        # Invalid domain should fail
        with pytest.raises(ValidationError) as exc_info:
            SpaceCreate(name="Test Space", calendar_url="https://evil.com/calendar")
    ...
    def test_calendar_url_validation_invalid_format(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            SpaceUpdate(calendar_url="not-a-valid-url")
        assert "must use HTTPS protocol" in str(exc_info.value)
...
class TestInvitationModels:
    ...
    def test_invitation_accept_model(self):
        ...
        accept_data = {"invitation_code": "abc123xyz"}
    ...
    def test_invitation_list_response_model(self):
        ...
        list_response = InvitationListResponse(invitations=invitations, total=2)
...
class TestRequestResponseModels:
    ...
    def test_error_response_model(self):
        ...
        error = ErrorResponse(detail="Resource not found", status_code=404)
    ...
    def test_success_response_model(self):
        ...
        success = SuccessResponse(message="Operation completed successfully", data={"id": "123"})
    ...
    def test_model_serialization(self):
        ...
        user = UserBase(email="test@example.com", username="testuser", full_name="Test User")
    ...
    def test_model_field_exclusion(self):
        ...
        user = UserCreate(email="test@example.com", username="testuser", password="secret123")
