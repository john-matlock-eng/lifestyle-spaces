...
import boto3
from app.core.database import get_dynamodb_resource, get_dynamodb_table, DynamoDBClient, get_db
...
class TestDatabaseFunctions:
    ...
    def test_get_dynamodb_table(self, mock_get_resource):
        ...
        mock_resource.Table.assert_called_once_with(settings.dynamodb_table)
...
class TestDynamoDBClient:
    ...
    def test_get_item_found(self, mock_get_table):
        ...
        mock_table.get_item.assert_called_once_with(Key={"PK": "USER#123", "SK": "PROFILE"})
    ...
    def test_update_item_multiple_fields(self, mock_get_table):
        ...
        client = DynamoDBClient()
        updates = {"field1": "value1", "field2": "value2", "field3": "value3"}
        result = client.update_item("USER#123", "PROFILE", updates)
    ...
    def test_delete_item(self, mock_get_table):
        ...
        assert result["ResponseMetadata"]["HTTPStatusCode"] == 200
        mock_table.delete_item.assert_called_once_with(Key={"PK": "USER#123", "SK": "PROFILE"})
