...
class TestDynamoDBClient:
    ...
    def test_db_client_operations(self):
        ...
        # Test put_item
        item = {"PK": "USER#123", "SK": "PROFILE", "name": "Test User", "email": "test@example.com"}
        ...
        client.put_item({"PK": "USER#123", "SK": "ORDER#001", "total": 100})
        client.put_item({"PK": "USER#123", "SK": "ORDER#002", "total": 200})
