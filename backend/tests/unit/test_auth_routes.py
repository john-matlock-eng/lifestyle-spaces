...
class TestAuthEndpoints:
    ...
    def test_signup_success(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito, patch(
            "app.services.user_profile.UserProfileService"
    ...
    def test_signin_success(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito:
            ...
            response = client.post(
                "/api/auth/signin", json={"email": "test@example.com", "password": "Test123!@#"}
            )
    ...
    def test_signin_invalid_credentials(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito:
            ...
            response = client.post(
                "/api/auth/signin", json={"email": "test@example.com", "password": "wrong"}
            )
    ...
    def test_refresh_token_success(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito:
            ...
            response = client.post("/api/auth/refresh", json={"refresh_token": "refresh123"})
    ...
    def test_refresh_token_invalid_credentials(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito:
            mock_service = Mock()
            mock_service.refresh_token.side_effect = InvalidCredentialsError(
    ...
    def test_signout_success(self):
        ...
        with patch("app.api.routes.auth.CognitoService") as mock_cognito:
            ...
            response = client.post(
                "/api/auth/signout", headers={"Authorization": "Bearer access123"}
            )
