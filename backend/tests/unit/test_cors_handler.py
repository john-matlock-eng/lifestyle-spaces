...
class TestCorsHandler:
    ...
    def test_allowed_origin_cloudfront(self):
        ...
        event = {"headers": {"origin": "https://duh187imz287k.cloudfront.net"}}
    ...
    def test_allowed_origin_localhost(self):
        ...
        for port in ["3000", "3001"]:
            event = {"headers": {"Origin": f"http://localhost:{port}"}}  # Test with capital O
    ...
    def test_dynamic_cloudfront_domain(self):
        ...
        event = {"headers": {"origin": "https://d123abc456.cloudfront.net"}}
    ...
    def test_dynamic_vercel_domain(self):
        ...
        event = {"headers": {"origin": "https://my-app.vercel.app"}}
    ...
    def test_dynamic_amplify_domain(self):
        ...
        event = {"headers": {"origin": "https://main.d1234abcd.amplifyapp.com"}}
    ...
    def test_unknown_origin_gets_wildcard(self):
        ...
        event = {"headers": {"origin": "https://unknown-domain.com"}}
