...
def test_get_pending_invitations_for_user(
    invitation_service, mock_dynamodb_client, sample_invitation_data
):
...
def test_get_pending_invitations_for_admin(
    invitation_service, mock_dynamodb_client, sample_invitation_data
):
...
def test_accept_invitation(
    invitation_service, mock_dynamodb_client, mock_space_service, sample_invitation_data
):
    ...
    invitation = invitation_service.accept_invitation(
        sample_invitation_data["invitation_id"],
        sample_invitation_data["user_id"],
        sample_invitation_data["invitee_email"],
    )
