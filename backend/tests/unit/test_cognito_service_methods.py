    ...
    def test_sign_up_success(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.sign_up.return_value = {"UserSub": "test-user-sub-123"}
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.admin_confirm_sign_up.assert_called_once_with(
                    UserPoolId="test-pool-id", Username="test@example.com"
                )
    ...
    def test_sign_up_generic_error(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.sign_up.side_effect = ClientError(
                    error_response={"Error": {"Code": "InternalError"}}, operation_name="SignUp"
                )
    ...
    def test_sign_in_invalid_credentials(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                # Create login request
                login = LoginRequest(email="test@example.com", password="WrongPassword")
    ...
    def test_sign_in_user_not_found(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                # Create login request
                login = LoginRequest(email="notfound@example.com", password="Test123!@#")
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.list_users.side_effect = ClientError(
                    error_response={"Error": {"Code": "InternalError"}}, operation_name="ListUsers"
                )
    ...
    def test_sign_out_success(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.global_sign_out.assert_called_once_with(AccessToken="test-access-token")
    ...
    def test_get_user_success(self):
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.get_user.assert_called_once_with(AccessToken="test-access-token")
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.get_user.side_effect = ClientError(
                    error_response={"Error": {"Code": "InternalError"}}, operation_name="GetUser"
                )
        ...
        try:
            ...
            with patch("boto3.client") as mock_boto_client:
                ...
                mock_client.list_user_pools.return_value = {
                    "UserPools": [{"Name": "lifestyle-spaces-test", "Id": "existing-pool-id"}]
                }
