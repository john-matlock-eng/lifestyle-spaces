...
class TestInvitationEndpoints:
    ...
    def setup_method(self):
        ...
        self.mock_user = {"sub": "user123", "email": "test@example.com", "username": "testuser"}
    ...
    def test_regenerate_invite_code_success_as_owner(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            mock_service_instance.get_member.return_value = {"user_id": "user123", "role": "owner"}
    ...
    def test_regenerate_invite_code_success_as_admin(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            mock_service_instance.get_member.return_value = {"user_id": "user123", "role": "admin"}
    ...
    def test_regenerate_invite_code_forbidden_as_member(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            mock_service_instance.get_member.return_value = {"user_id": "user123", "role": "member"}
    ...
    def test_join_space_with_code_success(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            response = self.client.post("/api/spaces/join", json={"invite_code": "TESTCODE"})
            ...
            mock_service_instance.join_space_with_invite_code.assert_called_once_with(
                invite_code="TESTCODE", user_id="user123"
            )
            mock_service_instance.get_space.assert_called_once_with(
                space_id="space123", user_id="user123"
            )
    ...
    def test_join_space_invalid_code(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            mock_service_instance.join_space_with_invite_code.side_effect = InvalidInviteCodeError(
                "Invalid code"
            )

            response = self.client.post("/api/spaces/join", json={"invite_code": "BADCODE"})
    ...
    def test_join_space_already_member(self):
        ...
        with patch("app.api.routes.spaces.SpaceService") as mock_service:
            ...
            mock_service_instance.join_space_with_invite_code.side_effect = AlreadyMemberError(
                "Already a member"
            )

            response = self.client.post("/api/spaces/join", json={"invite_code": "VALIDCODE"})
    ...
    def test_join_space_missing_invite_code(self):
        ...
        response = self.client.post("/api/spaces/join", json={})
