...
def test_content_tiptap_saved_and_retrieved(journal_service, mock_get_space, mock_is_member, mock_get_author):
    ...
    journal_service.table.get_item.return_value = {
        'Item': journal_item
    }
...
def test_content_tiptap_null_handling(journal_service, mock_get_space, mock_is_member, mock_get_author):
